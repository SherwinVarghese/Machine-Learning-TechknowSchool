...
-- --------------------------------------------------------------------------
call APLWRAPPER_CREATE_MODEL_AND_TRAIN(FUNC_HEADER, CREATE_AND_TRAIN_CONFIG, VARIABLE_DESC, VARIABLE_ROLES, APL_SAMPLES.ADULT01, MODEL_TRAIN_BIN, OPERATION_LOG, SUMMARY, INDICATORS) with overview;

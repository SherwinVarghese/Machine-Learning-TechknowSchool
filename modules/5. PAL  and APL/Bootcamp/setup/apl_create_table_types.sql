...
drop type INTERFACE_SIGNATURES_T;
create type INTERFACE_SIGNATURES_T as table (
    "FUNC_ID" INTEGER,
    "PARAM_SEQUENCE" INTEGER,
    "PARAM_NAME" VARCHAR(255),
    "PARAM_DIRECTION"INTEGER,
    "PARAM_DESCRIPTION" VARCHAR(255),
    "PARAM_SQLTYPE" VARCHAR(50),
    "PARAM_SQLLENGTH" INTEGER,
    "TABLETYPE_ID" INTEGER
);

drop type INTERFACE_TTYPES_T;
create type INTERFACE_TTYPES_T as table (
    "TABLETYPE_ID" INTEGER,
    "NAME" VARCHAR(255),
    "DESCRIPTION" VARCHAR(255),
    "REGEX" VARCHAR(256),
    "TABLEDESC_ID" INTEGER
);

drop type INTERFACE_TDESCS_T;
create type INTERFACE_TDESCS_T as table (
    "TABLEDESC_ID" INTEGER,
    "COLUMN_SEQUENCE" INTEGER,
    "COLUMN_NAME" VARCHAR(255),
    "COLUMN_CSTYPE" VARCHAR(50),
    "COLUMN_SQLTYPE" VARCHAR(50),
